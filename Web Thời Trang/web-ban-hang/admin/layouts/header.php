...
<body>
<link href="../admin/tong.css" rel="stylesheet">
<nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Chào <?=$user['fullname']?></a>
  <ul class="navbar-nav px-3">
    <li class="nav-item text-nowrap">
    <a class="FadeIn nav-link" href="<?=$baseUrl?>authen/logout.php">Đăng Xuất</a>
    </li>
  </ul>
</nav >	
    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          <li class="button1 button nav-item">
