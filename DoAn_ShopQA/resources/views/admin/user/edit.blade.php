                    ...
                    <div class="card-body">
                        <form method="post" action="/admin/user/{{ $user->id }}" enctype="multipart/form-data">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <img style="height: 200px; cursor: pointer;" class="thumbnail rounded-circle"
                                        data-toggle="tooltip" title="Nhấp để thay đổi ảnh đại diện" data-placement="bottom"
                                        src="front/img/avatar/{{$user->avatar ?? 'default.png'}}" alt="Avatar">
                                    <input name="image" type="file" onchange="changeImg(this)"
                                        class="image form-control-file" style="display: none;" value="">
                                    <input type="hidden" name="image_old" value="{{ $user->avatar }}">
                                    <small class="form-text text-muted">
                                        Nhấp để thay đổi ảnh(required)
                                    </small>
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="street_address" id="street_address" placeholder="Địa Chỉ" type="text"
                                        class="form-control" value="{{ $user->street_address }}">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="postcode_zip" id="postcode_zip" placeholder="Mã Bưu/ZIP" type="text"
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="phone" id="phone" placeholder="Số Điện Thoại"
                                        type="tel" class="form-control" value="{{ $user->phone }}">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                <label for="description" class="col-md-3 text-md-right col-form-label">Thông Tin
                                    Thêm</label>
                                <div class="col-md-9 col-xl-8">
