                                    ...
                                    <form method="post" action="admin/user" enctype="multipart/form-data">
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <img style="height: 200px; cursor: pointer;"
                                                    ...
                                                    title="Nhấp để thay đổi ảnh đại diện" data-placement="bottom"
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <input name="postcode_zip" id="postcode_zip"
                                                    placeholder="Mã Bưu/ZIP" type="text" class="form-control"
                                                    value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            <label for="description"
                                                   class="col-md-3 text-md-right col-form-label">Thông Tin Thêm</label>
                                            <div class="col-md-9 col-xl-8">
