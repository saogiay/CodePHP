			...
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-md-9 col-12">
						...
						<button class="btn btn-success"><input type="submit" name="SuaHD" value ="Cập Nhật Hóa Đơn" style="background: none; border: none; color: #fff;"></button>
					</div>
					<div class="col-md-3 col-12" style="border: solid grey 1px; padding-top: 10px; padding-bottom: 10px;">
						...
						<div class="form-group">
							...
							<input type="date" value="<?php echo $dataID['NgayLap']?>" name="ngaylap">
						</div>
						<div class="form-group">
							<label for="usr">Số Lượng:</label>
							<input type="number" value="<?php echo $dataID['SoLuong']?>" name="soluong">
						</div>
					</div>
				</div>
				</form>
...
?>
	...
	<!-- <form  method="post" >
		<table border="1" >
			<thead>
					<td colspan="2" align="center">Cập Nhật Hóa Đơn</td>
					...
					<tr>
						<td>Ngày Lập </td>
						<td><input type="date" value="<?php echo $dataID['NgayLap']?>" name="ngaylap"></td>
					</tr>

				<tr>
					<td>Số Lượng </td>
					<td>
						<input type="text" value="<?php echo $dataID['SoLuong']?>" name="soluong">
					</td>
				</tr>
				<tr>
					<td><input type="submit" name="SuaHD" value ="Cập Nhật"></td>
